...
export default function DoubleInputPropertyWithAddMinus(props: {
    title: string,
    numbers: {
        number1: number,
        number2: number
    }
    changeNumbers: (x?: number, y?: number, width?: number, height?: number) => void
}): JSX.Element {
    const {changeNumbers} = props
    const step = 10
    return (
        <FieldWrap>
            <ShowPlaceholder/>
            ...
            <FieldContainer>
                    ...
                    <DataInputNumber>
                        <DataInputContent>
                            <DataInput min={0} max={12000} step={1} spellCheck={false}
                                       value={props.numbers.number1}
                                       onChange={(e) =>
                                           changeNumbers(parseInt(e.target.value), props.numbers.number2)
                                       }/>
                        </DataInputContent>
                        <SpanButtonGroup>
                            <AddSpanButton onClick={() =>
                                changeNumbers(props.numbers.number1 + step, props.numbers.number2)
                            }>+</AddSpanButton>
                ...
                <DataInputWrap>
                    <DataInputNumber>
                        <DataInputContent>
                            <DataInput min={0} max={12000} step={1} spellCheck={false}
                                       value={props.numbers.number2}
                                       onChange={(e) =>
                                           changeNumbers(props.numbers.number1, parseInt(e.target.value))
                                       }/>
                        </DataInputContent>
                        <SpanButtonGroup>
                            <AddSpanButton onClick={() =>
                                changeNumbers(props.numbers.number1, props.numbers.number2 + step)
                            }>+</AddSpanButton>
                            <MinusSpanButton onClick={() =>
                                changeNumbers(props.numbers.number1, props.numbers.number2 - step)
                            }>-</MinusSpanButton>
